            ...
            <div className="bg-brand-blue text-white py-20 px-4">
                <div className="max-w-7xl mx-auto text-center space-y-6">
                    <h1 className="text-4xl md:text-6xl font-bold italic tracking-tight">
                        Grupos de <span className="text-brand-gold">Oração</span>
                    </h1>
                    <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                        Encontre um Grupo de Oração da Renovação Carismática Católica mais próximo de você e venha vivenciar Pentecostes!
                    </p>
                </div>
            </div>
