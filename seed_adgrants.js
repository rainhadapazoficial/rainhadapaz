...
const pages = [
    {
        ...
        content: `
            ...
            <p>Utilizamos ferramentas de estatística (como o rastreamento interno de acessos) para entender o alcance da nossa missão digital. Estes dados são anônimos.</p>
            <h3>3. Segurança</h3>
...
async function seed() {
    console.log("Seeding Ad Grants pages (JS)...");
